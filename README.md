...
### 🛠️ Computer Systems & Network Technician | SysAdmin | HelpDesk

A resolute, versatile, and flexible professional with experience analyzing and solving technical incidents across diverse business sectors.

- 🖥️ **SysAdmin & Support:** Experienced in hardware maintenance, system administration, and helpdesk support.
- 🌐 **Networks:** Skilled in network management, infrastructure configuration, and maintenance.
- 🎓 **Continuous Learning:** Constantly expanding knowledge through specialized IT training and certifications.
...
He pogut desenvolupar tasques de tècnic informàtic en empreses de diferents sectors on he millorat i adquirit coneixements com a tècnic de manteniment de hardware, manteniment i gestió de xarxes, administrador de sistemes i helpdesk.
</p>
</details>
...
* **📁 [Aplicatiu Web per gestió d'incidències informàtiques ITSM](https://github.com/mff1991/wp-sports-agenda)**
